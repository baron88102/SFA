...
word_without_normalize <- fn_sfa(data = serie_without_normalize,
...
word_normalize <- fn_sfa(data = serie_without_normalize,
                   sliding_window = length(serie_without_normalize),
                   wordlength = wl,
                   alphabet_size = as,
                   norm_mean = TRUE,
...
# # Esto es debido a la precisiòn de los diferentes lenguajes
#   # Aceptance threshold
#   umbral <- 0.98
# 
#   # Load original words
